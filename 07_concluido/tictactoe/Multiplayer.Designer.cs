namespace tictactoe
{
    partial class Multiplayer
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            vez.AutoSize = true;
            vez.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            vez.ForeColor = Color.Black;
            vez.Location = new Point(235, 32);
            vez.Name = "vez";
            vez.Size = new Size(119, 20);
            vez.TabIndex = 6;
            vez.Text = "Vez do Player";
            // 
            // button11
            // 
            button11.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            button11.Location = new Point(420, 556);
